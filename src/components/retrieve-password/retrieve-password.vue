<template>
  <div id="main-body">
    <div class="login-box flex" id="login-box">
      ...
      <label class="input-box-new flex" foe='code-input'>
        <div class="ibn-title">确认密码：</div>
        <div class="ibn-warp flex">
    ...
    _register() {
      ...
      findPassword(this.phone, this.password, this.rePassword, this.code).then((res) => {
        if (res.data.err_code === SUCCESS_CODE) {
          ...
          window.location.href = window.location.origin + '/login.html#/login?phone=' + this.phone
          return true
        } else {
          if (res.data.err_msg) {
            this.code = ''
